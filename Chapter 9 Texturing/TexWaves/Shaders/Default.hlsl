...
{
float4x4 gWorld;
float4x4 gTexTransform; //! used for transforming the input texture coordinates. Sometimes it makes more sense for the texture transform to be a property of the object (such as when we want to tile the texture by scaling the texture coordinate by 5)
};
