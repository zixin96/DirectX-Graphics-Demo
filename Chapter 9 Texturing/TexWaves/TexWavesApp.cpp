...
void TexWavesApp::BuildRenderItems()
{
	...
	XMStoreFloat4x4(&gridRitem->TexTransform, XMMatrixScaling(5.0f, 5.0f, 1.0f)); //! to tile the grass texture, we scale the texture coordinates by 5 so that the texture is tiled 5x5 times across the land mesh surface
