...
/**
 * \brief Encapsulates the actual ID3D12Resource object of the cube map,
 * the various descriptors to the resource, and other useful data for rendering to the cube map
 */
