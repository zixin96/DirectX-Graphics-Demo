...
/**
 * \brief Create vertex buffer that stores the 4 control points
 */
...
void BasicTessellationApp::BuildRenderItems()
{
	...
	quadPatchRitem->PrimitiveType      = D3D_PRIMITIVE_TOPOLOGY_4_CONTROL_POINT_PATCHLIST; // a patch with 4 control points
