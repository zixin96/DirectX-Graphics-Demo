...
class LODIscoTessApp : public D3DApp
{
public:
	LODIscoTessApp(HINSTANCE hInstance);
	LODIscoTessApp(const LODIscoTessApp& rhs)            = delete;
	LODIscoTessApp& operator=(const LODIscoTessApp& rhs) = delete;
	~LODIscoTessApp() override;
