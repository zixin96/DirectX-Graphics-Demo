...
void BlendApp::Draw(const GameTimer& gt)
{
	...
	//!? look here: 
	// experiment with drawing transparent objects first (if you first draw the water, nothing will be blended since there is nothing in the destination pixels)
