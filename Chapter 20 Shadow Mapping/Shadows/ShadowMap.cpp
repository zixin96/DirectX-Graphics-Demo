...
ShadowMap::ShadowMap(ID3D12Device* device, UINT width, UINT height)
{
	...
	// Note: the resolution of the shadow map affects the quality of our shadows
	// High resolution => more expensive to render into, more memory, better quality
	mWidth  = width;
	mHeight = height;

	mViewport = {
		0.0f,          // X position of the left hand side of the viewport
		0.0f,          // Y position of the top of the viewport
		(float)width,  // Width of the viewport
		(float)height, // Height of the viewport
		0.0f,          // Minimum depth of the viewport
		1.0f           // Maximum depth of the viewport
	};
	...
	// creates a depth/stencil texture of the specified dimensions and viewport
	BuildResource();
}
