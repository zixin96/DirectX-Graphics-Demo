...
struct ObjectConstants
{
	...
	//!? Add global time to the object constant buffer
	float Time;
};

class AnimatedBoxApp : public D3DApp
{
public:
	AnimatedBoxApp(HINSTANCE hInstance);
	AnimatedBoxApp(const AnimatedBoxApp& rhs)            = delete;
	AnimatedBoxApp& operator=(const AnimatedBoxApp& rhs) = delete;
	~AnimatedBoxApp() override;
