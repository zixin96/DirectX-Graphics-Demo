...
class BoxMultipleSlotsApp : public D3DApp
{
public:
	BoxMultipleSlotsApp(HINSTANCE hInstance);
	BoxMultipleSlotsApp(const BoxMultipleSlotsApp& rhs)            = delete;
	BoxMultipleSlotsApp& operator=(const BoxMultipleSlotsApp& rhs) = delete;
	~BoxMultipleSlotsApp() override;
