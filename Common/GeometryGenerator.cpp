...
{
	// The basic idea is to iterate over each ring, and generate the vertices that lie on that ring.
...
GeometryGenerator::MeshData GeometryGenerator::CreateCylinderNoCap(float bottomRadius, float topRadius, float height, uint32 sliceCount, uint32 stackCount)
{
	// The basic idea is to iterate over each ring, and generate the vertices that lie on that ring.
