...
/**
* \brief A static class for procedurally generating the geometry of common mathematical objects
...
public:
	...
	/**
	 * \brief A simple structure that holds a vertex/index list
	 * Used as the return value for creation functions
	 */
	struct MeshData
	{
	...
	// create a line strip approximating a circle
	MeshData CreateCycle(uint32 numSubdivisions, float radius);
